...
describe('workspace-project Cliente', () => {
    ...
    it('No deberia crear cliente con codigo repetido', () => {
        ...
        expect(toast.getNotificacion()).toEqual('El codigo del cliente ya existe en el sistema');
    });

    it('No deberia crear cliente con nombre repetido', () => {
        ...
        expect(toast.getNotificacion()).toEqual('El nombre del cliente ya existe en el sistema');
    });

    it('No deberia eliminar un cliente que ya ha sido comprado', () => {
        const CODIGO_PRODUCTO: string = 'AA20A';
        ...
        expect(toast.getNotificacion()).toEqual('El cliente ha sido comprado, elimine la servicioPrestado primero')
